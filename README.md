# Django REST Framework (DRF) + MySQL: RESTful API con Django | Tutorial desde Cero

Aprende a crear una RESTful API usando Django REST Framework (DRF) y el SGBD MySQL. Usaremos el protocolo HTTP junto con los métodos GET, POST, PUT y DELETE y el formato JSON para enviar y recibir datos.
